...
export default function Profil() {
    ...
    const showFormUpdateProfil = (e, _id) => {
        ...
        axios.get(`/api/edit-profil-stagiaire/${_id}`).then(res => {
            if (res.data.status === 200) {//si l'utilisateur est trouvé
    ...
    const updateProfil = (e) => {
        ...
        formData.append('cinpasseport', ProfileUserInput.cinpasseport);
        ...
        axios.post(`/api/profil-stagiaire/${user_id}`, formData).then(res => {
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className='row'>
                                            <div className="col-md-6">
                                                ...
                                                <input required type="text" name="cinpasseport" onChange={handleProfileInput} value={ProfileUserInput.cinpasseport} className="form-control" placeholder='Cin/Passeport' />
                    ...
                    <div className="card h-100">
                        ...
                        <div className="card-body p-3">
                            ...
                            <ul className="list-group">
                                ...
                                <li className="list-group-item border-0 ps-0 text-sm"><strong className="text-dark">Cin/Passeport:</strong> &nbsp;{user.cinpasseport}</li>
