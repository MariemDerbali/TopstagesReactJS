                        ...
                        <div className="col-lg-5 col-md-7 mx-auto">
                            <div className="card z-index-0 mt-sm-12 mt-9 mb-4">
                                <div className="card-header text-center pt-4 pb-1">
                                    ...
                                    <p className="mb-0">Vous recevrez un e-mail dans un délai maximum de 60 secondes
                                    </p>
                                </div>
                                <div className="card-body">
                                    <form role="form" onSubmit={TopnetforgotpasswordSubmit} >
                                        ...
                                        <div className="text-center">
                                            <button type="submit" className="btn bg-gradient-dark btn-lg w-100 my-4 mb-2">Envoyer</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
